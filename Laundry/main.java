 ...
 */
public class main {
    static Client client = new Client(); // static bisa untuk class lain tapi hanya sati object
    static Petugas petugas = new Petugas();//  new untuk membuat object baru
    static Transaksi transaksi = new Transaksi(); // constructor
    ...
    public static void main(String[] args){
        ...
        if(jawab.equalsIgnoreCase("y")){ //membandingkan string ke objek tertentu
            System.out.println("Masukkan ID Anda");
            int id = input.nextInt();
            menu(id);
        }
        else{
            System.out.println("Daftarkan Nama");
            String nama = input.next();
            client.setNama(nama);
            System.out.println("Buat ID untuk anda");
            int Id = input.nextInt();
